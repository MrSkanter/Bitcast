...
result$Real_cat <- ifelse(result$Alvo > 3.086029, 1, 0)
result$Prev_cat <- ifelse(result$Previsto > 3.086029, 1, 0)
...
ggplot(result, aes(x = Data)) +
  ...
  geom_line(aes(y = Previsto, color = "Prevista"), linetype = "dashed", size = 1) +
